...
#define  note_Gb3 185.00  //F#3/Gb3
#define  note_G3  196.00  //G3
#define  note_Ab3 207.65  //G#3/Ab3
#define  note_A3  220.00  //A3
...
#define  note_G4  392.00  //G4
#define  note_Ab4 415.30  //G#4/Ab4
#define  note_A4  440.00  //A4
...
{
public:
	static constexpr double WHOLE = 1.;
	static constexpr double HALF = 1./2.;
	static constexpr double QUARTER = 1./4.;
	static constexpr double EIGHTH = 1./8.;
	static constexpr double SIXTEENTH = 1./16.;
	...
	static double GetNoteFreq(const char * note, int octave);
